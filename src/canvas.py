...
class Canvas():
    ...
    def draw_blackbox(self):
        ...
        blackbox_fb = framebuf.FrameBuffer(blackbox_bytearray, 32,32, framebuf.MONO_HLSB)
        self.screen.blit(blackbox_fb, 0, 0)
    ...
    def _draw_battery_(self):
        ...
        battery_fb = framebuf.FrameBuffer(battery_bytearray, 128,32, framebuf.MONO_HLSB)
        self.screen.blit(battery_fb, 0, 0)
